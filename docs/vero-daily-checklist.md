...
- [x] `bunx shadcn@latest init` completed
  - [x] TypeScript: yes
  - [x] Tailwind: yes  
  - [x] App Router: yes
  - [x] ESLint: yes
- [x] Project starts without errors: `bun run dev`
- [x] Basic page renders at `http://localhost:3000`

**Dependencies Installed:**

- [x] `bun add idb uuid`
- [x] `bun add -d vitest @testing-library/react @testing-library/jest-dom jsdom`
- [x] No install errors

**Project Structure Created:**

- [x] `src/lib/` folder created
- [x] `src/hooks/` folder created
- [x] `src/app/dashboard/` folder created
- [x] `src/app/payments/` folder created (send, request, accept subfolders)
- [x] `src/app/funds/` folder created (add, withdraw subfolders)
- [x] `src/app/companies/` folder created
...
- [x] `Company` interface defined
- [x] `Transaction` interface defined (with all 4 types)
- [x] `PaymentRequest` interface defined
- [x] `Wallet` interface defined
- [x] File compiles without errors

**Database File (`src/lib/db.ts`):**

- [x] `initDB()` function created
...
- [x] `mockCompanies()` returns 3 test companies
- [x] `mockWallet()` creates $10k starting balance
- [x] `mockTransactions()` returns sample transactions
- [x] `mockPaymentRequests()` returns sample requests
- [x] `CURRENT_COMPANY_ID` constant defined

**Test Files Created:**

- [x] `src/lib/balance.test.ts` created
- [x] Test for starting balance passing ✓
- [x] Test for deducting payments passing ✓
- [x] Test for adding received payments passing ✓
- [x] Test for ignoring pending transactions passing ✓
- [x] `bun test` runs without errors

**Business Logic (`src/lib/balance.ts`):**

- [x] `calculateBalance()` function implemented
- [x] All tests passing: `bun test balance.test.ts`
